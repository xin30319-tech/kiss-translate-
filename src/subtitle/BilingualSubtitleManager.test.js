...
describe("BilingualSubtitleManager", () => {
  ...
  test("updates current subtitle and list callback when full sentence translation completes", async () => {
    ...
    deferred.resolve({ trText: "最终完整译文" });
  ...
  test("updates repaired chunk translations to caption and list callback on completion", async () => {
    const deferred = createDeferred();
    apiTranslate.mockReturnValue(deferred.promise);
