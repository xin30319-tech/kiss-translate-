...
- [x] **YouTube 后台播放跨页面无感跟随悬浮双语字幕**
  - **自动跟随显现**：当 YouTube 在后台播放视频时，切换到任意网页，屏幕底部自动浮现半透明、优雅的双语字幕卡片，实时同步双语字幕与播放进度。
  - **交互与控制**：支持按住拖拽移动位置（自动记忆）、A-/A+ 快捷缩放字体大小、一键 ⏯️ 播放/暂停及 ⏪/⏩ 快进快退后台视频、点击标题直接切回 YouTube 标签页。
  - **无感淡出**：切回 YouTube 页面或视频停止后自动智能淡出收起，不影响正常网页浏览。
